    ...
    methods
        ...
        function visualize(this)
            ...
            this.Figures(2) = mag.graphics.visualize( ...
                ...
                Title = sprintf("From: (t_{0} + %s) - To: (t_{end} - %s)", string(scienceStartTime - hk.Time(1)), string(scienceEndTime - hk.Time(end))), ...
                Name = "+-8V Close Up", ...
                Arrangement = [3, 1], ...
                LinkXAxes = true, ...
                WindowState = "maximized");
            ...
            if ~isempty(primary.Events) && ~isempty(secondary.Events)
                ...
                this.Figures(3) = mag.graphics.visualize( ...
                    ...
                    mag.graphics.style.LeftRight(Title = "3.3 V", LeftLabel = "[V]", RightLabel = "[mA]", LLimits = 3.3 + this.VOffset, Charts = [mag.graphics.chart.Plot(YVariables = "P3V3V"), mag.graphics.chart.Plot(YVariables = "P3V3I")]), ...
                    mag.graphics .style.Default(Title = "2.4 V", YLabel = "[V]", Charts = mag.graphics.chart.Plot(YVariables = "P2V4V"))], ...
                    primary, mag.graphics.style.Default(Title = compose("%s Modes", primarySensor), YLabel = "mode [-]", Charts = mag.graphics.chart.custom.Event(EventOfInterest = "DataFrequency")), ...
                    ...
                    primary, mag.graphics.style.Default(Title = compose("%s Ranges", primarySensor), YLabel = "range [-]", Charts = mag.graphics.chart.custom.Event(EventOfInterest = "Range", YOffset = 0.1, IgnoreMissing = false)), ...
                    secondary, mag.graphics.style.Default(Title = compose("%s Ranges", secondarySensor), YLabel = "range [-]", Charts = mag.graphics.chart.custom.Event(EventOfInterest = "Range", YOffset = 0.1, IgnoreMissing = false)), ...
                    Name = "HK & Events", ...
                    Arrangement = [4, 2], ...
                    LinkXAxes = true, ...
                    WindowState = "maximized");
