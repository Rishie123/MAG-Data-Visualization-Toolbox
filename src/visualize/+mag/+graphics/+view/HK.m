        ...
        function visualize(this)
            ...
            if ~isempty(primary.Events) && ~isempty(secondary.Events)
                ...
                this.Figures(end + 1) = mag.graphics.visualize( ...
                    ...
                    secondary.Events, mag.graphics.style.Default(Title = compose("%s Ranges", secondarySensor), YLabel = "range [-]", YLimits = "manual", Charts = mag.graphics.chart.custom.Event(EventOfInterest = "Range", YOffset = 0.1, IgnoreMissing = false)), ...
                    Name = "HK & Events", ...
                    Arrangement = [4, 2], ...
                    LinkXAxes = true, ...
                    WindowState = "maximized");
