    ...
    methods
        ...
        function visualize(this)
            ...
            this.Figures(1) = mag.graphics.visualize( ...
                ...
                mag.graphics.style.Stackedplot(Title = "Temperature", YLabels = ["ICU " + this.TLabel, primarySensor + " " + this.TLabel, secondarySensor + " " + this.TLabel], RotateLabels = true, Layout = [2, 1], Charts = mag.graphics.chart.Stackedplot(YVariables = ["ICU", primarySensor, secondarySensor] + "_TEMP"))], ...
                Name = "HK Time Series", ...
                Arrangement = [6, 2], ...
                LinkXAxes = true, ...
