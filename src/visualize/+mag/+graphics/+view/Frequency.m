    ...
    methods (Access = private)
        ...
        function charts = getFrequencyCharts(this, name)
            ...
            charts = [ ...
                ...
                mag.graphics.style.Colormap(YLabel = this.FLabel, CLabel = this.PLabel, YLimits = "tight", Layout = [2, 1], Charts = mag.graphics.chart.Spectrogram(YVariables = "X")), ...
                mag.graphics.style.Default(Title = compose("%s y", name), YLabel = "[nT]", Charts = mag.graphics.chart.Plot(YVariables = "Y")), ...
                mag.graphics.style.Colormap(YLabel = this.FLabel, CLabel = this.PLabel, YLimits = "tight", Layout = [2, 1], Charts = mag.graphics.chart.Spectrogram(YVariables = "Y")), ...
                mag.graphics.style.Default(Title = compose("%s z", name), YLabel = "[nT]", Charts = mag.graphics.chart.Plot(YVariables = "Z")), ...
                mag.graphics.style.Colormap(YLabel = this.FLabel, CLabel = this.PLabel, YLimits = "tight", Layout = [2, 1], Charts = mag.graphics.chart.Spectrogram(YVariables = "Z"))];
        end
