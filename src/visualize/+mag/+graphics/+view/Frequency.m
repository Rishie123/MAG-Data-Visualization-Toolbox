    ...
    methods 
        ...
        function visualize(this)
            ...
            this.Figures = mag.graphics.visualize( ...
                psdPrimary, mag.graphics.style.Default(Title = compose("%s PSD", primarySensor) , XLabel = this.FLabel, YLabel = this.PSDLabel, XScale = "log", YScale = "log", Legend = ["x", "y", "z"], Layout = [2, 3], Charts = [mag.graphics.chart.Plot(XVariable = "f", YVariables = ["x", "y", "z"]), yLine]), ...
                psdSecondary, mag.graphics.style.Default(Title = compose("%s PSD", secondarySensor), XLabel = this.FLabel, YLabel = this.PSDLabel, XScale = "log", YScale = "log", Legend = ["x", "y", "z"], Layout = [2, 3], Charts = [mag.graphics.chart.Plot(XVariable = "f", YVariables = ["x", "y", "z"]), yLine]), ...
                primary, ...
